...
class App {
    ...
    constructor() {
        ...
        this.RowsManagerObj = new RowsManager(this.rowData, 0, // Initial starting row block index
        ...
        // from `ScrollManagerObj`.
        this.ColumnsManagerObj = new ColumnsManager(this.columnData, 0, // Initial starting column block index
        ...
        this.JSONUploadObj = new JSONUpload(this.cellData, this.TilesManagerObj);
