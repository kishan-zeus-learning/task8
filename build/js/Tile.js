...
export class Tile {
    ...
    renderSelected(ctx) {
        ...
        if ((this.selectionCoordinates.selectionStartRow >= tileStartRowNum && this.selectionCoordinates.selectionStartRow <= tileEndRowNum) && (this.selectionCoordinates.selectionStartColumn >= tileStartColNum && this.selectionCoordinates.selectionStartColumn <= tileEndColNum)) {
            ...
            console.log("Selection Coordinates:", "StartRow:", this.selectionCoordinates.selectionStartRow, "EndRow:", this.selectionCoordinates.selectionEndRow, "StartCol:", this.selectionCoordinates.selectionStartColumn, "EndCol:", this.selectionCoordinates.selectionEndColumn, "| Tile Bounds:", "StartRow:", tileStartRowNum, "EndRow:", tileEndRowNum, "StartCol:", tileStartColNum, "EndCol:", tileEndColNum);
        }
        ctx.beginPath();
