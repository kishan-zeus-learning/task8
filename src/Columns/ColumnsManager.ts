...
export class ColumnsManager {
    /** @type {ColumnData} Stores custom column widths keyed by column index */
    ...
    /** @type {number} The current total scroll width of the visible columns in pixels. */
    private scrollWidth: number;

    /** @type {number} The starting left pixel position of the first visible column block. */
